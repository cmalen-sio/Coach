...
import org.sio2.coach.R;
import org.sio2.coach.controleur.Controle;
    ...
    private void ecouteCalcul(){
        ((Button) findViewById(R.id.btnCalc)).setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                // Toast.makeText(MainActivity.this, "test", Toast.LENGTH_SHORT).show();  // message test dans appli
                // Log.d("message","clic ok sur le bouton calcul*************************************");  // message test dans console
    ...
    private void afficheResult(Integer poids, Integer taille, Integer age, Integer sexe){
        ...
        if(message == "normal"){
            ...
            if(message == "trop faible"){
                imgSmiley.setImageResource(R.drawable.skinny2);
            }else {
